...
# Add a classification column to the production data
prod_data_long <- prod_data_long %>%
  mutate(
...
# Step 2: Filter for Developed and Developing countries only
prod_data_classified <- prod_data_long %>%
  filter(Country_Category %in% c("Developed", "Developing"))

# Step 3: Aggregate production by year and country category
